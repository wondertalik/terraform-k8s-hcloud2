...
| `ingress_load_balancer_create_manual`                    | `false`                  | Create load balancer for ingress explicitly                                                                                                       |    No    |
...
- cilium [1.13.3](https://artifacthub.io/packages/helm/cilium/cilium)
